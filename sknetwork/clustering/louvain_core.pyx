    ...
    while increase == 1:
        ...
        for i in range(n):
            ...
            if not unique_clusters.empty():
                ...
                delta_exit -= ratio_ou * abs((in_clusters_weights[cluster_node] - node_prob_in)-0.2) 
                delta_exit -= ratio_in * abs((ou_clusters_weights[cluster_node] - node_prob_ou)-0.2) 
                ...
                for cluster in unique_clusters:
                    ...
                    delta -= ratio_ou * abs(in_clusters_weights[cluster]-0.2)
                    delta -= ratio_in * abs(ou_clusters_weights[cluster]-0.2) 
